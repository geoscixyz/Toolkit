...
To get initiated with the tools in the Geophysical Toolkit, we have set up both :ref:`synthetic<synth_example>` and :ref:`real-life<search_example>` examples that can be walked through by interested geoscientists looking to understand how the tools function. Users can also directly upload :ref:`their own data<tools>` to apply and explore the same applications.
